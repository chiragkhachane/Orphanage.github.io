...
if(isset($_POST['add'])){
    ...
    $sql = "INSERT INTO teachers(name,email,phone,photo,qual)VALUES(?,?,?,?,?)";

    $stmt=$conn->prepare($sql);

    $stmt->bind_param("sssss",$name,$email,$phone,$upload,$qual);
    $stmt->execute();
...
if(isset($_POST['update'])){
    ...
    $sql="UPDATE teachers SET name=?, email=?, phone=?,photo=?,qual=? WHERE id=?";
    $stmt=$conn->prepare($sql);
    $stmt->bind_param("sssssi",$name,$email,$phone,$newimage,$qual,$id);
    $stmt->execute();
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="donor.php">Donations</a>
      </li>
    </ul>
  </div> 
  <form class="form-inline" action="/action_page.php">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <h3 class="text-center text-dark mt-2">Teacher Records</h3>
                <hr> 
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="text" name="qual" value="<?=$qual; ?>" class="form-control" placeholder="Qualification" required>
                    </div>
                    <div class="form-group">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> 
                                    ...
                                    | <a href="teachers.php?edit=<?= $row['id']; ?>" class="badge badge-success p-2">Edit</a> |
                                    <a href="teachers.php?delete=<?= $row['id']; ?>" class="badge badge-danger p-2" onclick="return confirm('Confirm delete?')">Delete</a> |
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
